                        ...
                        <div class="row" style="margin-bottom:40px">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <select name="category" class="form-control">
                                                {!! getCategory($categories,0,'',$product->category->id) !!}
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  name="featured" class="form-control">
                                                <option @if (!$product->featured) {{ 'selected' }} @endif value="0">Không</option>
                                                <option @if ($product->featured) {{ 'selected' }} @endif value="1">Có</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <img id="avatar" class="thumbnail" width="100%" height="350px" src="../uploads/{{ $product->img }}">
